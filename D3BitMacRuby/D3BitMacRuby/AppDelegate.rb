...
class AppDelegate
  ...
  #
  # Returns the directory the application uses to store the Core Data store file. This code uses a directory named "D3BitMacRuby" in the user's Library directory.
  #
  def applicationFilesDirectory
      ...
      library_url.URLByAppendingPathComponent("D3BitMacRuby")
  end
  ...
  def managedObjectModel
      unless @managedObjectModel
        model_url = NSBundle.mainBundle.URLForResource("D3BitMacRuby", withExtension:"momd")
  ...
  def persistentStoreCoordinator
      ...
      url = directory.URLByAppendingPathComponent("D3BitMacRuby.storedata")
